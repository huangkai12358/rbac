...
public interface UserHistoryMapper {
    ...
    @Select("insert into sys_user_history (user_id, version, username, password, nickname, email, status, secret_token, auth_version, operate_type, operate_time, operator_id)" +
            "values " +
