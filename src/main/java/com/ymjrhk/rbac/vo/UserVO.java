...
//    private LocalDateTime lastLoginTime;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(userId, username, nickname, email, status, version, secretToken, createTime, updateTime);
    }

    @Override
    public String toString() {
        return "UserVO" + "{" + "userId=" + userId + ", " + "username=" + username + ", " + "nickname=" + nickname + ", " + "email=" + email + ", " + "status=" + status + ", " + "version=" + version + ", " + "secretToken=" + secretToken + ", " + "createTime=" + createTime + ", " + "updateTime=" + updateTime + "}";
    }
